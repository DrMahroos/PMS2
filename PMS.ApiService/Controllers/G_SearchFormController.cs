...
{
    public class G_SearchFormController : BaseController, IBaseController
    {
        /// <summary>
        ...
        {
            var result = this.Get<G_SearchForm>(SqlStatement);
        ...
        public ResponseResult InsertEntity(JObject data)
        {
            ...
            var obj = JObjectData<G_SearchForm>(data);
            obj.Entity = result.ResponseData as G_SearchForm;
            data = JObjectToObj<G_SearchForm>(obj.Entity, obj.Session);
            result = this.Execute<G_SearchForm>(data, ActionTypes.Insert, this.Process);
            return result;
        }
        ...
        public ResponseResult UpdateEntity(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_SearchForm;
            data = JObjectToObj<G_SearchForm>(obj.Entity, obj.Session);
            result = this.Execute<G_SearchForm>(data, ActionTypes.Update, this.Process);
            return result;
        }
        ...
        public ResponseResult DeleteEntity(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_SearchForm;
            data = JObjectToObj<G_SearchForm>(obj.Entity, obj.Session);
            result = this.Execute<G_SearchForm>(data, ActionTypes.Delete, this.Process);
            return result;
        ...
        public ResponseResult InsertCollection(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_SearchForm;
            data = JObjectToObj<G_SearchForm>(obj.Entity, obj.Session);
            result = this.Execute<G_SearchForm>(data, ActionTypes.InsertCollection, this.Process);
            return result;
        }
