...
{
    public class G_BRANCHController : BaseController, IBaseController
    {
        /// <summary>
        ...
        {
            var result = this.Get<G_BRANCH>(SqlStatement);
        ...
        public ResponseResult InsertEntity(JObject data)
        {
            ...
            var obj = JObjectData<G_BRANCH>(data);
            obj.Entity = result.ResponseData as G_BRANCH;
            data = JObjectToObj<G_BRANCH>(obj.Entity, obj.Session);
            result = this.Execute<G_BRANCH>(data, ActionTypes.Insert, this.Process);
            return result;
        }
        ...
        public ResponseResult UpdateEntity(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_BRANCH;
            data = JObjectToObj<G_BRANCH>(obj.Entity, obj.Session);
            result = this.Execute<G_BRANCH>(data, ActionTypes.Update, this.Process);
            return result;
        }
        ...
        public ResponseResult DeleteEntity(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_BRANCH;
            data = JObjectToObj<G_BRANCH>(obj.Entity, obj.Session);
            result = this.Execute<G_BRANCH>(data, ActionTypes.Delete, this.Process);
            return result;
        ...
        public ResponseResult InsertCollection(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_BRANCH;
            data = JObjectToObj<G_BRANCH>(obj.Entity, obj.Session);
            result = this.Execute<G_BRANCH>(data, ActionTypes.InsertCollection, this.Process);
            return result;
        }
