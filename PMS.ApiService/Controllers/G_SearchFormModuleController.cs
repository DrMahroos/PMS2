...
{
    public class G_SearchFormModuleController : BaseController, IBaseController
    {
        /// <summary>
        ...
        {
            var result = this.Get<G_SearchFormModule>(SqlStatement);
        ...
        public ResponseResult InsertEntity(JObject data)
        {
            ...
            var obj = JObjectData<G_SearchFormModule>(data);
            obj.Entity = result.ResponseData as G_SearchFormModule;
            data = JObjectToObj<G_SearchFormModule>(obj.Entity, obj.Session);
            result = this.Execute<G_SearchFormModule>(data, ActionTypes.Insert, this.Process);
            return result;
        }
        ...
        public ResponseResult UpdateEntity(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_SearchFormModule;
            data = JObjectToObj<G_SearchFormModule>(obj.Entity, obj.Session);
            result = this.Execute<G_SearchFormModule>(data, ActionTypes.Update, this.Process);
            return result;
        }
        ...
        public ResponseResult DeleteEntity(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_SearchFormModule;
            data = JObjectToObj<G_SearchFormModule>(obj.Entity, obj.Session);
            result = this.Execute<G_SearchFormModule>(data, ActionTypes.Delete, this.Process);
            return result;
        ...
        public ResponseResult InsertCollection(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_SearchFormModule;
            data = JObjectToObj<G_SearchFormModule>(obj.Entity, obj.Session);
            result = this.Execute<G_SearchFormModule>(data, ActionTypes.InsertCollection, this.Process);
            return result;
        }
