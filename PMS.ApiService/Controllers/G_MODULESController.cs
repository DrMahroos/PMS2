...
{
    public class G_MODULESController : BaseController, IBaseController
    {
        /// <summary>
        ...
        {
            var result = this.Get<G_MODULES>(SqlStatement);
        ...
        public ResponseResult InsertEntity(JObject data)
        {
            ...
            var obj = JObjectData<G_MODULES>(data);
            obj.Entity = result.ResponseData as G_MODULES;
            data = JObjectToObj<G_MODULES>(obj.Entity, obj.Session);
            result = this.Execute<G_MODULES>(data, ActionTypes.Insert, this.Process);
            return result;
        }
        ...
        public ResponseResult UpdateEntity(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_MODULES;
            data = JObjectToObj<G_MODULES>(obj.Entity, obj.Session);
            result = this.Execute<G_MODULES>(data, ActionTypes.Update, this.Process);
            return result;
        }
        ...
        public ResponseResult DeleteEntity(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_MODULES;
            data = JObjectToObj<G_MODULES>(obj.Entity, obj.Session);
            result = this.Execute<G_MODULES>(data, ActionTypes.Delete, this.Process);
            return result;
        ...
        public ResponseResult InsertCollection(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_MODULES;
            data = JObjectToObj<G_MODULES>(obj.Entity, obj.Session);
            result = this.Execute<G_MODULES>(data, ActionTypes.InsertCollection, this.Process);
            return result;
        }
