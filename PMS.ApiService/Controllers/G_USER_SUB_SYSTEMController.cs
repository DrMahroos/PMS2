...
{
    public class G_USER_SUB_SYSTEMController : BaseController, IBaseController
    {
        /// <summary>
        ...
        {
            var result = this.Get<G_USER_SUB_SYSTEM>(SqlStatement);
        ...
        public ResponseResult InsertEntity(JObject data)
        {
            ...
            var obj = JObjectData<G_USER_SUB_SYSTEM>(data);
            obj.Entity = result.ResponseData as G_USER_SUB_SYSTEM;
            data = JObjectToObj<G_USER_SUB_SYSTEM>(obj.Entity, obj.Session);
            result = this.Execute<G_USER_SUB_SYSTEM>(data, ActionTypes.Insert, this.Process);
            return result;
        }
        ...
        public ResponseResult UpdateEntity(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_USER_SUB_SYSTEM;
            data = JObjectToObj<G_USER_SUB_SYSTEM>(obj.Entity, obj.Session);
            result = this.Execute<G_USER_SUB_SYSTEM>(data, ActionTypes.Update, this.Process);
            return result;
        }
        ...
        public ResponseResult DeleteEntity(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_USER_SUB_SYSTEM;
            data = JObjectToObj<G_USER_SUB_SYSTEM>(obj.Entity, obj.Session);
            result = this.Execute<G_USER_SUB_SYSTEM>(data, ActionTypes.Delete, this.Process);
            return result;
        ...
        public ResponseResult InsertCollection(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_USER_SUB_SYSTEM;
            data = JObjectToObj<G_USER_SUB_SYSTEM>(obj.Entity, obj.Session);
            result = this.Execute<G_USER_SUB_SYSTEM>(data, ActionTypes.InsertCollection, this.Process);
            return result;
        }
