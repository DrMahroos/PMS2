...
{
    public class G_USER_FAVORITEController : BaseController
    {
        //G_USER_FAVORITE
        /// <summary>
        ...
        {
            var result = this.Get<G_USER_FAVORITE>(SqlStatement);
        ...
        public ResponseResult InsertEntity(JObject data)
        {
            ...
            var obj = JObjectData<G_USER_FAVORITE>(data);
            obj.Entity = result.ResponseData as G_USER_FAVORITE;
            data = JObjectToObj<G_USER_FAVORITE>(obj.Entity, obj.Session);
            result = this.Execute<G_USER_FAVORITE>(data, ActionTypes.Insert, this.Process);
            return result;
        }
        ...
        public ResponseResult UpdateEntity(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_USER_FAVORITE;
            data = JObjectToObj<G_USER_FAVORITE>(obj.Entity, obj.Session);
            result = this.Execute<G_USER_FAVORITE>(data, ActionTypes.Update, this.Process);
            return result;
        }
        ...
        public ResponseResult DeleteEntity(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_USER_FAVORITE;
            data = JObjectToObj<G_USER_FAVORITE>(obj.Entity, obj.Session);
            result = this.Execute<G_USER_FAVORITE>(data, ActionTypes.Delete, this.Process);
            return result;
        ...
        public ResponseResult InsertCollection(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_USER_FAVORITE;
            data = JObjectToObj<G_USER_FAVORITE>(obj.Entity, obj.Session);
            result = this.Execute<G_USER_FAVORITE>(data, ActionTypes.InsertCollection, this.Process);
            return result;
        }
