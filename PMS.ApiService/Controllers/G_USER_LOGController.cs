...
{
    public class G_USER_LOGController : BaseController, IBaseController
    {
        /// <summary>
        ...
        {
            var result = this.Get<G_USER_LOG>(SqlStatement);
        ...
        public ResponseResult InsertEntity(JObject data)
        {
            ...
            var obj = JObjectData<G_USER_LOG>(data);
            obj.Entity = result.ResponseData as G_USER_LOG;
            data = JObjectToObj<G_USER_LOG>(obj.Entity, obj.Session);
            result = this.Execute<G_USER_LOG>(data, ActionTypes.Insert, this.Process);
            return result;
        }
        ...
        public ResponseResult UpdateEntity(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_USER_LOG;
            data = JObjectToObj<G_USER_LOG>(obj.Entity, obj.Session);
            result = this.Execute<G_USER_LOG>(data, ActionTypes.Update, this.Process);
            return result;
        }
        ...
        public ResponseResult DeleteEntity(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_USER_LOG;
            data = JObjectToObj<G_USER_LOG>(obj.Entity, obj.Session);
            result = this.Execute<G_USER_LOG>(data, ActionTypes.Delete, this.Process);
            return result;
        ...
        public ResponseResult InsertCollection(JObject data)
        {
            ...
            obj.Entity = result.ResponseData as G_USER_LOG;
            data = JObjectToObj<G_USER_LOG>(obj.Entity, obj.Session);
            result = this.Execute<G_USER_LOG>(data, ActionTypes.InsertCollection, this.Process);
            return result;
        }
