...
namespace PMS.ServiceConnector.Models
{
    ...
    public partial class I_Pay_Vendor
    {
        public int VendorID { get; set; }
        public int CompCode { get; set; }
        public string VendorCode { get; set; }
        public Nullable<int> VndCatID { get; set; }
        ...
        public Nullable<System.DateTime> CommRegIssueDate { get; set; }
        public string CommRegIssueDateH { get; set; }
        public string CommRegIssuePlace { get; set; }
        public Nullable<byte> VATType { get; set; }
        public Nullable<byte> AddDedType { get; set; }
        public string VATFileNo { get; set; }
        public string AddDedFileNo { get; set; }
        public string VATIssPlace { get; set; }
        public string AddDedIssuePlace { get; set; }
