...
function createPoisson() {
	var poisson = $('<img>', {
		id:'poisson', 
		class:'poisson',
        src: "/AssistiveTouch/static/img/poisson.png",
	}).css({
		top: '1px',
		left: '1px'
	}); 
...
var PadLayout = {
	main :{
        'aa': 'add', 'ab': 'add', 'ac':'add',
        'ba':'btnUpdate','bb':'back',   'bc':'device',
        'ca': 'add', 'cb': 'add', 'cc':'add'
	},
	gesture :{
	...
	device : {
        ...
        'ca': 'filelist', 'cb': 'filelist', 'cc':'filelist'
	},
};
/*
 * create grid pad 3x3
