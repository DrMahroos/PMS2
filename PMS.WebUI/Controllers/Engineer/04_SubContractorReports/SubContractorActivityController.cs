...
namespace PMS.WebUI.Controllers.Engineer._04_SubContractorReports
{
    ...
    public class SubContractorActivityController : Controller
    {
        DbEntities db = new DbEntities();
       
        public ActionResult SubContractorActivityIndex()
        {
           
            return View(Path.SubContrActivity);
        ...
        public JsonResult GetSrchEngProject(int id)
        {
        ...
        public JsonResult GetSrchEngPhase(int id)
        {
