...
namespace PMS.WebUI.Controllers
{
    ...
    public class PeriodBudgetController : Controller, IController
    {
        ...
        public ActionResult PeriodBudgetIndex()
        {
        ...
        public JsonResult UpdateRecord(P_G_Period entity)
        {
