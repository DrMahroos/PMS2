...
{
    public class ProductionComparisController : Controller
    {
        DbEntities db = new DbEntities();
        // GET: ProductionComparison
        public ActionResult ProductionComparisonIndex()
        {
            return View(Path.ProductionComparison);
        }
