...
{
    public class ProjectCostVarianController : Controller
    {
        // GET: ProjectCostVariance
        DbEntities db = new DbEntities();
        
        public ActionResult ProjectCostVarianIndex()
        {
            return View(Path.RepProjectCostVarian);
        }
