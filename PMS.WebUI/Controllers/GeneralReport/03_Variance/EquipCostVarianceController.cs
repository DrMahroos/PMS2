...
{
    public class EquipCostVarianceController : Controller
    {
        DbEntities db = new DbEntities();
        // GET: EquipCostVariance
        public ActionResult EquipCostVarianceIndex()
        {
            return View(Path.RepEquipCostVariance);
        }
