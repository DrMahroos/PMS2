...
(function (OfferSpecification) {
    var ControllerName = "OfferSpecification";
    var TableName = "P_TR_SalesOffer";
    var FieldKey = "OfferID";
    var JsGridcombobox = "combobox";
    var columnWidth = "70px";
    //------------------------Parent
    ...
    var _OfferStageId = 0;
    //------------------------
    var MasterDetails = new M_D_OfferSpecification();
    var MasterDetailsView = new M_D_OfferSpecificationView();
    ...
    var DetailsAssignHeaderDetails = new PQ_GetSlsOfferActivity();
    var DataSourceChild = new Array();
    var FilterDataSourceChild = new Array();
    var newDataSourceChild = new Array();
    ...
    OfferSpecification.InitalizeComponent = InitalizeComponent;
    //------------------------
    function InitalizeGridParent() {
        ...
        GridParent.Columns = [
            ...
            //},
            {
                ...
                headerTemplate: function () {
                    var txt = DocumentActions.CreateElement("label"); //CreateElement("label", GridInputClassName, " ", " ", "ItemID", " ");
                    txt.id = "h_ItemCode";
            ...
            },
            {
                ...
                headerTemplate: function () {
                    var txt = DocumentActions.CreateElement("label"); //CreateElement("label", GridInputClassName, " ", " ", "Qty", " ");
                    txt.id = "h_Qty";
            ...
            },
            {
                ...
                headerTemplate: function () {
                    var txt = DocumentActions.CreateElement("label"); //CreateElement("label", GridInputClassName, " ", " ", "UnitPrice", " ");
                    txt.id = "h_UnitPrice";
                    txt.onkeyup = function (e) {
                        CalcTotal();
                    };
            ...
            //},
            {
                ...
                headerTemplate: function () {
                    var txt = DocumentActions.CreateElement("label"); //CreateElement("label", GridInputClassName, " ", " ", "Remarks", " ");
                    txt.id = "h_Remarks";
    ...
    function GridParent_OnRowDoubleClicked() {
        debugger;
        var _Items = GridParent.SelectedItem;
        ...
        newDataSourceChild = DataSourceChild.filter(function (items) { return items.OfferID == _Items.OfferID && items.OfferItemId == _Items.OfferItemId; });
    ...
    function InitalizeGrid() {
        ...
        GridChild.OnRefreshed = function () {
        ...
        GridChild.OnItemInserting = function () { };
        GridChild.OnItemUpdating = function () { };
        GridChild.OnItemDeleting = function () { };
        GridChild.Columns = [
            {
            ...
            },
            {
                ...
                itemTemplate: function (s, item) {
                    ...
                    btn.onclick = function (e) {
                        ...
                        var data = newDataSourceChild[index];
                        var newIndex = 0;
    ...
    function DeleteActivity(entity) {
    ...
    function AddItemActivityInGrid() {
        ...
        for (var _i = 0, newDataSourceChild_1 = newDataSourceChild; _i < newDataSourceChild_1.length; _i++) {
            var itm = newDataSourceChild_1[_i];
    ...
    function btnComputePro_onclick() {
        ...
        for (var _i = 0, DataSourceParent_1 = DataSourceParent; _i < DataSourceParent_1.length; _i++) {
            ...
            var _TotalItem = item.Qty * item.UnitPrice;
            var _Act = _ItemAct.filter(function (x) { return x.OfferItemId = item.OfferItemId; });
            var _TotalAct = 0;
            for (var _a = 0, _Act_1 = _Act; _a < _Act_1.length; _a++) {
                var itemAct = _Act_1[_a];
    ...
    function btnTr_onclick() {
        sys.FindKey(Modules.OfferSpecification, "btnTr", "CompCode = " + _CompCode + " and BraCode = " + _BraCode, function () {
            var id = ClientSharedWork.SearchDataGrid.SelectedKey;
            var _Index = GetIndexByUseId(id, TableName, FieldKey, " CompCode = " + _CompCode + " and BraCode = " + _BraCode);
    ...
    function LoadDetails(id) {
        AjaxApi.CallAsyncApi({
            ...
            success: function (d) {
                var result = d;
                if (result.IsSuccess) {
                    DataSourceParent = result.Response.PQ_GetSlsOfferStageItem;
                    DataSourceChild = result.Response.PQ_GetSlsOfferActivity;
                    GridParent.DataSource = DataSourceParent;
                    GridParent.Bind();
                }
            }
    ...
    function Assign() {
        ...
        //AssignDetails
        MasterDetails.P_Tr_SalesOfferStageItem = DataSourceParent;
        MasterDetails.P_Tr_SalesOfferStageItemActivity = DataSourceChild;
    }
    function New() {
    ...
    function btnFindAtcivity_onclick() {
        sys.FindKey(Modules.OfferSpecification, "btnFindAtcivity", "CompCode = " + _CompCode + " and IsDetail =" + 1, function () {
            var id = ClientSharedWork.SearchDataGrid.SelectedKey;
            debugger;
            AjaxApi.CallAsyncApi({
                type: "GET",
    ...
    function ValidationPrc() {
        ...
        for (var _i = 0, DataSourceParent_2 = DataSourceParent; _i < DataSourceParent_2.length; _i++) {
            var itm = DataSourceParent_2[_i];
            FilterDataSourceChild = DataSourceChild.filter(function (x) { return x.OfferID == itm.OfferID && x.OfferItemId == itm.OfferItemId; });
            // load item activity 
            ProdPrc = 0;
...
//# sourceMappingURL=OfferSpecification.js.map