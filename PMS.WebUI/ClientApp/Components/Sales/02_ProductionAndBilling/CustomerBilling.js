...
(function (CustomerBilling) {
    ...
    var txtRemarks;
    var txtDoNo;
    var l1_InvoiceAmount;
    var l1_InvoiceVat;
    var l1_InvoiceNetVAT;
    var li2_AdvAmount;
    var li2_AdvVat;
    var li2_AdvNet;
    var li3TaxableTotalAmount;
    var li3TaxableTotalVAT;
    var li3TaxableTotalNetVAT;
    var li4RetentionAmount;
    var li4ayablemount;
    var li5AdvanceConsumPrc;
    var li5UsedAmount;
    var li5RemainAmount;
    var vatPrc;
    var downpaymentPrc;
    ...
    function InitalizeGrid() {
        ...
        GridSales.Columns = [
            ...
            },
            {
                ...
                headerTemplate: function () {
                    var txt = CreateElement("label", GridInputClassName, " ", " ", "PrevBillQty", " ");
            ...
            },
            {
                ...
                headerTemplate: function () {
                    var txt = CreateElement("label", GridInputClassName, " ", " ", "ItemDiscountPrc", " ");
                    txt.disabled = false;
                    txt.onkeyup = function (e) {
                        CalcDiscAmount();
                        CalcUnitNetPrice();
            ...
            },
            {
                ...
                headerTemplate: function () {
                    var txt = CreateElement("label", GridInputClassName, " ", " ", "ItemDiscountAmt", " ");
                    txt.disabled = false;
            ...
            },
            {
                ...
                headerTemplate: function () {
                    var txt = CreateElement("label", GridInputClassName, " ", " ", "NetUnitPrice", " ");
                    txt.disabled = true;
    ...
    function InitalizeControls() {
        ...
        ChkDownpayment = DocumentActions.GetElementById("ChkDownpayment");
        li2_AdvPrc = DocumentActions.GetElementById("li2_AdvPrc");
        txtDoNo = DocumentActions.GetElementById("txtDoNo");
        l1_InvoiceAmount = DocumentActions.GetElementById("l1_InvoiceAmount");
        l1_InvoiceVat = DocumentActions.GetElementById("l1_InvoiceVat");
        l1_InvoiceNetVAT = DocumentActions.GetElementById("l1_InvoiceNetVAT");
        li2_AdvAmount = DocumentActions.GetElementById("li2_AdvAmount");
        li2_AdvVat = DocumentActions.GetElementById("li2_AdvVat");
        li2_AdvNet = DocumentActions.GetElementById("li2_AdvNet");
        li3TaxableTotalAmount = DocumentActions.GetElementById("li3TaxableTotalAmount");
        li3TaxableTotalVAT = DocumentActions.GetElementById("li3TaxableTotalVAT");
        li3TaxableTotalNetVAT = DocumentActions.GetElementById("li3TaxableTotalNetVAT");
        li4RetentionAmount = DocumentActions.GetElementById("li4RetentionAmount");
        li4ayablemount = DocumentActions.GetElementById("li4ayablemount");
        li5AdvanceConsumPrc = DocumentActions.GetElementById("li5AdvanceConsumPrc");
        li5UsedAmount = DocumentActions.GetElementById("li5UsedAmount");
        li5RemainAmount = DocumentActions.GetElementById("li5RemainAmount");
        ...
        Ajax.CallAsync({
            ...
            success: function (d) {
                ...
                if (Master != null) {
                    ...
                    var Index = GetIndexByUseId(Number(Master.InvoiceId), "PQ_GetSalesInvoice", "InvoiceId", " CompCode = " + _CompCode + " and BraCode = " + _BraCode);
            ...
            success: function (d) {
                ...
                if (result.IsSuccess == true) {
                    ...
                    MessageBox.Show(msg, "Insert", function () {
                        var _Index = GetIndexByUseId(result.Response, "PQ_GetSalesInvoice", "InvoiceId", "CompCode = " + _CompCode + " and BraCode = " + _BraCode);
    ...
    function Assign() {
        ...
        for (var _i = 0, DetailsSales_1 = DetailsSales; _i < DetailsSales_1.length; _i++) {
            ...
            var itm = new P_TR_SalesInvoiceDetail();
        ...
        Ajax.Callsync({
            ...
            success: function (d) {
                ...
                MessageBox.Show(msg, "ReOpen", function () {
                    var index = GetIndexByUseId(Master.InvoiceId, "PQ_GetSalesInvoice", "InvoiceId", "CompCode = " + _CompCode + " and BraCode = " + _BraCode);
                    NavigateToSearchResultKey(Number(index), Navigate);
                    //LoadDetails(Master.ProjectID);
                });
            }
    ...
    function btnCalc_Clicked() {
        ...
        for (var _i = 0, DetailsSales_3 = DetailsSales; _i < DetailsSales_3.length; _i++) {
            var itm = DetailsSales_3[_i];
    ...
    function Calculationlien2() {
        var ItemNet = 0;
        for (var _i = 0, DetailsSales_4 = DetailsSales; _i < DetailsSales_4.length; _i++) {
            var itm = DetailsSales_4[_i];
        ...
        if (ClientSharedWork.CurrentMode == ScreenModes.Add == true && Master.IsDownpayment == false) {
            var ressult1 = (ItemNet * AdvanceConsumPrc_ / 100);
            var ressult2 = (RemainDownpayment * 100) / (MasterVatPrc + 100);
    ...
    function btnSearchBill_Clicked() {
        sys.FindKey(Modules.CustomerBilling, "btnSearchBill", "CompCode = " + _CompCode + " and BraCode = " + _BraCode, function () {
            var id = ClientSharedWork.SearchDataGrid.SelectedKey;
            Ajax.CallAsync({
    ...
    function GetAdvance(id) {
        ...
        Ajax.Callsync({
            ...
            success: function (d) {
                var invList = d.result;
                var result_ = invList.filter(function (x) { return x.ProjectID == ProjectID && x.IsDownpayment == true && x.Status == 1; });
                if (result_.length >= 1) {
