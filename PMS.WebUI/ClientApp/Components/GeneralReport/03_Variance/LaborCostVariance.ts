...
namespace LaborCostVariance {

    var sys: SystemTools = new SystemTools();
    const ControllerName: string = "LaborCostVariance";
    ...
    function btnProjectEng_onclick() {
        ...
        sys.FindKey(Modules.RepLaborCostVariance, "btnProjectEng", Condition, () => {
    ...
    function btnCustClassID_onclick() {
        ...
        sys.FindKey(Modules.RepLaborCostVariance, "btnCustClassID", "", () => {
    ...
    function btnCustID_onclick() {
        ...
        sys.FindKey(Modules.RepLaborCostVariance, "btnCustID", "", () => {
    ...
    function btnScopeCatID_onclick() {
        ...
        sys.FindKey(Modules.RepLaborCostVariance, "btnScopeCatID", ""/* "CompCode = " + _CompCode*/, () => {
    ...
    function butScope_onclick() {
        ...
        sys.FindKey(Modules.RepLaborCostVariance, "butScope_Code", "", () => {
