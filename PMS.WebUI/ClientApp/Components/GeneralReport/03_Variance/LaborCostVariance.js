$(document).ready(function () {
    LaborCostVariance.InitalizeComponent();
});
var LaborCostVariance;
(function (LaborCostVariance) {
    var sys = new SystemTools();
    var ControllerName = "LaborCostVariance";
    ...
    LaborCostVariance.InitalizeComponent = InitalizeComponent;
    ...
    function btnProjectEng_onclick() {
        sys.FindKey(Modules.RepLaborCostVariance, "btnProjectEng", Condition, function () {
    ...
    //    sys.FindKey(Modules.RepLaborCostVariance, "btnSalesID", Condition, () => {
    ...
    function btnCustClassID_onclick() {
        sys.FindKey(Modules.RepLaborCostVariance, "btnCustClassID", "", function () {
            var _Id = ClientSharedWork.SearchDataGrid.SelectedKey;
            Ajax.CallAsync({
    ...
    function btnCustID_onclick() {
        sys.FindKey(Modules.RepLaborCostVariance, "btnCustID", "", function () {
            var _Id = ClientSharedWork.SearchDataGrid.SelectedKey;
            Ajax.CallAsync({
    ...
    function btnScopeCatID_onclick() {
        sys.FindKey(Modules.RepLaborCostVariance, "btnScopeCatID", "" /* "CompCode = " + _CompCode*/, function () {
    ...
    function butScope_onclick() {
        sys.FindKey(Modules.RepLaborCostVariance, "butScope_Code", "", function () {
            var _Id = ClientSharedWork.SearchDataGrid.SelectedKey;
            Ajax.CallAsync({
    ...
    function Print() {
        ...
        if (($("#RedProject").prop("checked") == true)) {
            RP.TypeReport = 1;
            Ajax.CallAsync({
                url: Url.Action("repProjectLaborVariance", "GeneralReports"),
                data: RP,
                success: function (d) {
                    debugger;
                    var result = d.result;
...
//# sourceMappingURL=LaborCostVariance.js.map