...
namespace ByProject {
    ...
    const ControllerName: string = "ByProject";
    ...
    function btnBranch_onclick() {
        ...
        sys.FindKey(Modules.ByProject, "btnBranch", "", () => {
    ...
    function btnCustClassID_onclick() {
        ...
        sys.FindKey(Modules.ByProject, "btnCustClassID", "", () => {
    ...
    function btnScopeCatID_onclick() {
        ...
        sys.FindKey(Modules.ByProject, "btnScopeCatID", ""/* "CompCode = " + _CompCode*/, () => {
            let id = ClientSharedWork.SearchDataGrid.SelectedKey;
            Ajax.CallAsync({
    ...
    function butScopeID_onclick() {
        ...
        sys.FindKey(Modules.ByProject, "butScopeID", "", () => {
