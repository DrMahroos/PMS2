...
(function (WorkActivities) {
    ...
    function btnUomID_Clicked() {
        sys.FindKey(Modules.WorkActivities, "btnUomID", "CompCode = " + _CompCode, function () {
    ...
    function btnParentActivity_Clicked() {
        sys.FindKey(Modules.WorkActivities, "btnParentActivity", "CompCode = " + _CompCode, function () {
            var id = ClientSharedWork.SearchDataGrid.SelectedKey;
            Ajax.CallAsync({
                url: Url.Action("activityList", ControllerName),
                data: { id: id },
    ...
    function btnFindMaterial_onclick() {
        sys.FindKey(Modules.WorkActivities, "btnFindMaterial", "CompCode = " + _CompCode, function () {
    ...
    function btnFindLabor_onclick() {
        sys.FindKey(Modules.WorkActivities, "btnFindLabor", "", function () {
            var _Id = ClientSharedWork.SearchDataGrid.SelectedKey;
            Ajax.CallAsync({
    ...
    function btnFindEquip_onclick() {
        sys.FindKey(Modules.WorkActivities, "btnFindEquip", "", function () {
            var _Id = ClientSharedWork.SearchDataGrid.SelectedKey;
            Ajax.CallAsync({
