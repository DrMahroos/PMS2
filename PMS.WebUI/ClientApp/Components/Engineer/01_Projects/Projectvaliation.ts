...
namespace Projectvaliation {
    const ControllerName: string = "Projectvaliation";
    ...
    var Ppro_Details: Array<PProc_EngVariationLoadItem_Result> = new Array<PProc_EngVariationLoadItem_Result>();
    ...
    var txtItemProgQty: HTMLInputElement;
    var txtItemProdQty: HTMLInputElement;
    var txtTotalItemProdQty: HTMLInputElement;
    var txtNewItemPrdQty: HTMLInputElement;
    ...
    function InitalizeControls() {
        ...
        txtItemProgQty = DocumentActions.GetElementById<HTMLInputElement>("txtItemProgQty");
        txtItemProdQty = DocumentActions.GetElementById<HTMLInputElement>("txtItemProdQty");
        txtTotalItemProdQty = DocumentActions.GetElementById<HTMLInputElement>("txtTotalItemProdQty");
        txtNewItemPrdQty = DocumentActions.GetElementById<HTMLInputElement>("txtNewItemPrdQty");
    ...
    function InitalizeGrid() {
        ...
        GridItems.Columns = [
            ...
            },
            {
                ...
                headerTemplate: (): HTMLElement => {
                    let txt = CreateElement("label", GridInputClassName, " ", " ", "ProgressQty", " ");
                    txt.disabled = true;
        ...
        GridActivities.Columns = [
            ...
            },
            {
                ...
                headerTemplate: (): HTMLElement => {
                    let txt = CreateElement("label", GridInputClassName, " ", " ", "TotProdQty", " ");
                    txt.disabled = true;
                    txt.id = "h_TotProdQty";
            ...
            },
            {
                ...
                headerTemplate: (): HTMLElement => {
                    let txt = CreateElement("label", GridInputClassName, " ", " ", "UnderProdQty", " ");
                    txt.disabled = true;
            ...
            },
            {
                ...
                headerTemplate: (): HTMLElement => {
                    let txt = CreateElement("label", GridInputClassName, " ", " ", "OldEffItemQty", " ");
                    txt.disabled = true;
            ...
            },
            {
                ...
                headerTemplate: (): HTMLElement => {
                    let txt = CreateElement("label", GridInputClassName, " ", " ", "NewEffItemQty", " ");
                    txt.disabled = true;
    ...
    function Assign() {
        ...
        for (var variation of DetailsItems) {
            ...
            variation.itm_DescA = ""; variation.itm_DescL = "";
        ...
        for (var variationAct of DetailsActivities) {
            ...
            variationAct.Act_DescA = ""; variationAct.Act_DescE = "";
    ...
    function CheckTotals(): boolean {
        ...
        let oldProd: number = 0;
        let newProd: number = 0;
        // for it  of items 
        for (var itm of DetailsItems) {
    ...
    function PProc_EngVariationLoadItem(id: number) {
        ...
        Ajax.Callsync({
            ...
            data: { trID: id },
            success: (d) => {
                let result = d.result as PProc_EngVariationLoadItem_Result;
    ...
    function LoadVariatedActivity(id: number) {
        Ajax.Callsync({
            ...
            success: (d) => {
                ...
                for (var itm of DetailsActivities) {
    ...
    function calculationneweffqty() {
        let selectedItem: PQ_GetEngVariationItem = GridItems.SelectedItem as PQ_GetEngVariationItem;
        let h_ProdQty = Number($('#h_TotProdQty').val()) == null ? 0 : Number($('#h_TotProdQty').val());
        let h_UnderProdQty = Number($('#h_UnderProdQty').val()) == null ? 0 : Number($('#h_UnderProdQty').val());
        let resut1: number = (h_ProdQty + h_UnderProdQty);

        let h_ActivQty = Number($('#h_ActivQty').val()) == null ? 0 : Number($('#h_ActivQty').val());
        let h_ProductionPrc = Number($('#h_ProductionPrc').val()) == null ? 0 : Number($('#h_ProductionPrc').val());
        let NewItemQty = selectedItem.ItemQty == null ? 0 : selectedItem.ItemQty;
